...
export const actions = {
  // get
  getRegion ({ commit }, params) {
    commit('LOAD_REGION', true)
    return new Promise((resolve, reject) => {
      this.$axios.$get('/region/city/list/').then((res) => {
  ...
  getRegionById ({ commit }, payload) {
    ...
    return new Promise((resolve, reject) => {
      this.$axios.$get(`region/city/detail/${payload}/`).then((res) => {
        resolve(res)
      }).catch((error) => {
        commit('ERROR_REGION', error)
        reject(error)
  ...
  postRegion ({ commit }, payload) {
    ...
    return new Promise((resolve, reject) => {
      this.$axios.$post('region/city/create/', payload.data).then((res) => {
        resolve(res)
      }).catch((error) => {
        commit('ERROR_REGION', error)
        reject(error)
  ...
  updateRegion ({ commit }, payload) {
    commit('PENDING_REGION', true)
    return new Promise((resolve, reject) => {
      this.$axios.$put(`region/city/update/${payload.id}/`, payload.data).then((res) => {
        resolve(res)
      }).catch((error) => {
        commit('ERROR_REGION', error)
        reject(error)
  ...
  deleteRegion ({ commit }, payload) {
    ...
    return new Promise((resolve, reject) => {
      this.$axios.$remove(`region/city/delete/${payload}`).then((res) => {
        resolve(res)
      }).catch((error) => {
        commit('ERROR_REGION', error)
        reject(error)
