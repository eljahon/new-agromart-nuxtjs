      ...
      >
        <div class="group w-full hover:shadow-md shadow-sm">
          <div class="flex justify-center px-2 pt-2 w-full">
            <img v-if="consultant.avatar === null " src="https://silkozari.com/web/images/miscellaneous/avatar.jpg" class="w-full md:h-52 h-20 rounded-md object-cover">
            <img v-else class="w-full md:h-56 h-20 rounded-md object-cover" :src="$tools.getFileUrl(consultant.avatar)">
          </div>
          <div class="text-center md:text-left relative pt-2.5">
            ...
            <p v-if="consultant.consultantcategory !== null" class="text-gray-600 text-xs md:text-left line-clamp-1 text-center m-2">
          ...
          >
            <div class="p-3">
              ...
              <p v-if="consultant.consultantcategory !== null" class="text-sm text-green-600">
                {{ consultant.consultantcategory.title[$i18n.locale] }}
              </p>
