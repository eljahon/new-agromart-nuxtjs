      ...
      <div class="grid md:grid-cols-4 grid-cols-1 md:gap-6 md:space-y-0 space-y-6">
            ...
            <div v-if="events.length > 0">
              <div v-for="(event, index) in events" :key="index">
                <p class="text-sm text-gray-600 py-2">
                  {{ event.title[$i18n.locale] === "None" ? $t('none-translate') : event.title[$i18n.locale] }}
                </p>
        ...
        <div class="col-span-2 h-auto">
          <h3 class="text-gray-700 font-medium md:text-4xl text-2xl">
            {{ news.title[$i18n.locale] === "None" ? $t('none-translate') : news.title[$i18n.locale]  }}
          </h3>
          <div class="mt-4 md:flex block items-center justify-between">
            <p class="text-green-500 md:text-base text-sm">
              {{ news.category.title[$i18n.locale] === "None" ? $t('none-translate') : news.category.title[$i18n.locale] }}
            </p>
          </div>
          ...
          <p class="text-gray-700 md:text-base text-sm mt-4">
            {{ news.description[$i18n.locale] === "None" ? $t('none-translate') : news.description[$i18n.locale] }}
          </p>
          <img
          ...
          <div v-if="news.content[$i18n.locale] !== 'None'" class="my-3 text-base text-gray-700" v-html="news.content[$i18n.locale]" />
