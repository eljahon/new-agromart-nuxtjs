    ...
    <div v-if="!loading">
      <div class="max-w-3xl mx-auto">
        <h3 class="text-gray-700 font-medium md:text-4xl text-lg">
          {{ informationDetail.title[$i18n.locale] === 'None' ? $t('none-translate') : informationDetail.title[$i18n.locale] }}
        </h3>
        <p class="text-green-500 md:text-base text-sm pt-3">
          {{ informationDetail.description[$i18n.locale] === 'None' ? $t('none-translate') : 
