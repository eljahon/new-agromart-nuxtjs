  ...
  <div>
    <div class="py-8 px-3 sm:px-10">
      ...
      <div v-if="activetab === '1'">
        <socials />
        <form class="space-y-5 mt-5" action="#" method="POST">
          <div>
            <div class="mt-1">
              <input
                name="text"
      ...
      <div v-if="activetab === '3'">
        <div class="mt-3">
          ...
          <div class="bg-gray-400 rounded-md flex justify-center" @click="activetab = '4'">
            <button class="text-white text-base p-2 focus:outline-none">
      ...
      <div v-if="activetab === '4'">
        ...
        <p class="text-sm text-gray-500 mb-2">
          Kodni <span class="text-light-orange">3 : 00</span> daqiqadan so'ng qaytadan yuborish mumkin
        </p>
        ...
        <div class="flex justify-center mt-3">
          ...
          <button class="text-gray-400 text-sm ml-1 focus:outline-none">
            Qaytadan yuborish
          </button>
        </div>
      </div>
